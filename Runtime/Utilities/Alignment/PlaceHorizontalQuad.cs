...
public class PlaceHorizontalQuad : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        upperRight = new Vector3(upperRight.x, lowerLeft.y, upperRight.z);
        Vector3[] verts = {
            lowerLeft,
            new Vector3(lowerLeft.x, lowerLeft.y, lowerLeft.z), //upper left
            upperRight,
